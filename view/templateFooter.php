...
<footer >
    <div class="row rowFooter">
        <p class="text-center col-lg">site réalisé par Thibaut Gerin</p>
        <p class="text-center col-lg">lisence</p>
    </div>
</footer>
<!---------------------------------->
<!--slick js-->
...
<!--mes scripts :-->
<!--navbar Fixed TEST-->
<script src="../scripts/navFixe.js"></script>
<!--navbar Fixed TEST-->
<script src="../scripts/hideAndShow.js"></script>
<script src="../scripts/lastLeasonModificator.js"></script>
